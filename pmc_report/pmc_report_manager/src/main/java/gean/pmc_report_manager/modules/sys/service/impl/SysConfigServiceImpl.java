...
import gean.pmc_report_manager.modules.sys.dao.SysConfigDao;
import gean.pmc_report_manager.modules.sys.entity.SysConfigEntity;
import gean.pmc_report_manager.modules.sys.redis.SysConfigRedis;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigDao, SysConfigEntity> implements SysConfigService {
	...
	public <T> T getConfigObject(String key, Class<T> clazz) {
		...
		try {
			...
			throw new ReportException("获取参数失败");
		}
	}
}
