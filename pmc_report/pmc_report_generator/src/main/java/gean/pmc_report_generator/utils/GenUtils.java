...
import gean.pmc_report_generator.entity.ColumnEntity;
import gean.pmc_report_generator.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "gean.pmc_report_manager" : mainPath;
		...
		for(String template : templates){
			...
			try {
				...
				throw new ReportException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig(){
		try {
			...
			throw new ReportException("获取配置文件失败，", e);
		}
	}
