package gean.pmc_report_manager.common.aspect;


import gean.pmc_report_common.common.exception.ReportException;
import gean.pmc_report_manager.common.annotation.DataFilter;
import gean.pmc_report_manager.common.utils.Constant;
import gean.pmc_report_manager.modules.sys.entity.SysUserEntity;
import gean.pmc_report_manager.modules.sys.service.SysDeptService;
import gean.pmc_report_manager.modules.sys.service.SysRoleDeptService;
import gean.pmc_report_manager.modules.sys.service.SysUserRoleService;
import gean.pmc_report_manager.modules.sys.shiro.ShiroUtils;
...
public class DataFilterAspect {
    ...
    @Pointcut("@annotation(gean.pmc_report_manager.common.annotation.DataFilter)")
    ...
    public void dataFilter(JoinPoint point) throws Throwable {
        ...
        throw new ReportException("数据权限接口，只能是Map类型参数，且不能为NULL");
    }
