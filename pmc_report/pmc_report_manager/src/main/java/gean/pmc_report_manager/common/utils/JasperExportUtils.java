...
public class JasperExportUtils {
	 ...
	 public static Long exoprtName = System.currentTimeMillis();
	 /**
	  * 按照类型导出不同格式文件
	  * 
	  * @param datas
	 ...
	 * @throws JRException
	 */
	public static void exportExcel(JasperPrint jasperPrint,HttpServletRequest request,HttpServletResponse response) throws IOException,JRException{
		
	/**
	 * 设置头信息	
	 */
		response.setContentType("application/vnd.ms-excel");
		String fileName = new String((exoprtName.toString()+".xls").getBytes("GBK"),"ISO8859_1");
	...
	public static void exportWord(JasperPrint jasperPrint,
	  ...
	  String fileName = new String((exoprtName.toString()+".doc").getBytes("GBK"), "ISO8859_1");
	  response.setHeader("Content-disposition", "attachment; filename="
	    + fileName);
